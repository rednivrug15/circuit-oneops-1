...
attribute 'application_path',
  ...
  :required    => "required",
  :format      => {
    :help      => 'Relative path of the application.',
    :editable  => 'false',
    :important => 'true',
    :category  => '3.General',
    :order     => 1
...
attribute 'create_new_application_pool',
  :description => 'Create new application pool',
  :default     => 'true',
  :format      => {
...
:format      => {
  ...
  :category  => '2.IIS Application Pool',
  :order     => 2,
  :filter    => {'all' => {'visible' => 'create_new_application_pool:eq:true'}},
  :form      => {
                  'field' => 'select',
